...
TEMPLATES = [
    {
        ...
        "DIRS": [BASE_DIR/"templates"], # if template folder is pushed to root folder
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
EMAIL_BACKEND="django.core.mail.backends.console.EmailBackend" #in production smtp instead of console
